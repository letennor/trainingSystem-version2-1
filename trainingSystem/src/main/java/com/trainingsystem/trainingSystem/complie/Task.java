package com.trainingsystem.trainingSystem.complie;


import com.trainingsystem.trainingSystem.util.common.FileUtil;
import lombok.Data;
...
public class Task {
    ...
    public Answer compileAndRun(Question question) throws IOException, InterruptedException {
        ...
        FileUtil.writeFile(CODE, question.getCode());//此时用户写的东西是不包括方法的模板的，只是方法里面的内容
